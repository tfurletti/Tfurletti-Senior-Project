...
public class ExitButtonPause : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler {
    ...
    /*
        ...
        to click the exit button and close the application from the pause menu. 
    ...
    /*
        ...
        exit button to highlight the button for click verification. 
